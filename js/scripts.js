$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Hochzeit von Serena und Luca",

            // Event start date
            start: new Date('Aug 13, 2021 10:00'),
            ...
            end: new Date('Aug 13, 2021 23:59'),

            // Event Address
            address: 'Traumgarten Thalwil',

            // Event Description
            description: "Wir freuen uns auf Dich. Bei Fragen steht euch Samira Peyer gerne zur Verfügung."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 47.2840477, lng: 8.5665525};
